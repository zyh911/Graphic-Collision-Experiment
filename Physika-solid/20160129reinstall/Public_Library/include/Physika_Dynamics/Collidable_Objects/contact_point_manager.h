...
public:
    ...
    //get & set
    void setCollisionResult(CollisionPairManager<Scalar, Dim>& collision_result); // get contact points and normals from the pair manager
...
protected:
    ...
    //contact sampling
    void getMeshContactPoint(CollisionPairMeshToMesh<Scalar>* collision_pair); // compute contact point and normal for collision detection method DTBVH
};
