...
protected:
	unsigned int object_lhs_index_;   // 碰撞物体对 左物体索引
	unsigned int object_rhs_index_;   // 碰撞物体对 右
	MeshBasedCollidableObject<Scalar>* object_lhs_;   // 碰撞物体对 左物体指针
	MeshBasedCollidableObject<Scalar>* object_rhs_;
	unsigned int face_lhs_index_;
	unsigned int face_rhs_index_;
	SurfaceMeshInternal::Face<Scalar>* face_lhs_;    // 碰撞接触面对 左面指针
	SurfaceMeshInternal::Face<Scalar>* face_rhs_;    // 碰撞接触面对 右面指针
};
