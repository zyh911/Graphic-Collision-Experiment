...
{
    bool is_collide = scene_bvh_.selfCollide(this->collision_pairs_); // only detect, don't compute collision point and normal
    (this->contact_points_).setCollisionResult(this->collision_pairs_); // compute here
    return is_collide;
}
